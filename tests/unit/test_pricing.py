...
class TestEstimateAccuracyStubbed:
    ...
    def test_sonnet_2_page_estimate_within_envelope(self, pricing, tiny_pdf):
        ...
        # Input tokens: heuristic is text_chars/4 + pages*1750 + 200 system.
        # Real Bedrock returns approximate token counts on the same inputs.
        # ±100% bound — basically "same order of magnitude". The estimate
        # overshoots on image-heavy docs and undershoots on text-heavy ones.
        ...
        # Output: model nondeterminism + our flat 500/page constant means
        # this one is genuinely hard. Accept anything within 3x.
