...
# The vertical presets added for secure prototyping (F3). The three originals
...
# Record-type presets added to cover the document/agent use cases not in the
# original verticals (RAG corpora, agent-building, document extraction).
USE_CASE_GAP_PRESETS = {
...
def test_list_presets_covers_originals_and_verticals():
    ...
    assert USE_CASE_GAP_PRESETS <= names, USE_CASE_GAP_PRESETS - names
