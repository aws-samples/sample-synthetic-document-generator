...
# the downstream workload. Aligned to common SA/customer use cases (RAG eval,
# agent building, document extraction, …).
...
# A strong worked example for the custom / describe path — a representative
  ...
  <form class="card" hx-post="/preview" hx-target="#preview" hx-swap="outerHTML"
   ...
   <div class="seeds">
    ...
    <div class="seedpane" data-seed="upload">
      ...
      <label>Upload a reference document to mirror its shape. The values are audited
