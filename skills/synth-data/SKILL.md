...
description: >
  ...
  or a real sample document. Validate generated data against its schema. Use
  ...
  business description or a sample PDF into a reusable data schema. Wraps the
...
real document or a description spends Bedrock tokens.
